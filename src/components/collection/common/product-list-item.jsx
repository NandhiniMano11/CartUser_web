...
class ProductListItem extends Component {
    ...
    render() {
        ...
        console.log(product, 'productdatattatt')
        ...
        return (
            ...
            <div className="product-box">
                <div className="img-wrapper">
                    <div className="front">
                        <Link to={`${process.env.PUBLIC_URL}/right-sidebar/product/${product._id}`} ><img
                    ...
                    <div className="cart-info cart-wrap">
                        ...
                        <a alt='' title="Add to Wishlist" onClick={onAddToWishlistClicked} >
                            <i className="fa fa-heart" aria-hidden="true"></i>
                        </a>
                        <a alt='' data-toggle="modal"
                ...
                <div className="product-detail">
                    <div>
                        ...
                        <Link to={`${process.env.PUBLIC_URL}/right-sidebar/product/${product._id}`}>
                            <h6>{product.name_english}</h6>
                        </Link>
                        <h4>{symbol}{product.offer_price}
                                    ...
                                    <div className="col-lg-6 rtl-text">
                                        <div className="product-right">
                                            ...
                                            <div className="product-description border-product">
                                                {product.size_des ?
                                                    <div className="size-box">
                                                        <ul>
                                                            {product.size_des.split(",").map((size, i) => {
                                            ...
                                            <div className="product-buttons">
                                                ...
                                                <Link to={`${process.env.PUBLIC_URL}/right-sidebar/product/${product._id}`} className="btn btn-solid">GET BEST PRICE</Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
