            ...
            <div className="product-filter-content">
                ...
                <div className="product-page-filter">
                    <select onChange={(e) => this.props.filterSort(e.target.value)}>
                        ...
                        <option value="HighToLow">Category1</option>
                        <option value="LowToHigh">Category2</option>
                        <option value="Newest">Category3</option>
                        <option value="AscOrder">Category4</option>
                        <option value="DescOrder">Category5</option>
                    </select>
                </div>
            </div>
        )
