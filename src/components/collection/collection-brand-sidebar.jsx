...
import BrandListing from "./common/brand-listing";
import StickyBox from "react-sticky-box";

class CollectionBrandSidebar extends Component {
componentDidMount() {
    ...
    render (){
        return (
            <div>
                ...
                <Helmet>
                    <title>sanaya</title>
                    <meta name="description" content="Sanaya" />
                </Helmet>
                {/*SEO Support End */}
                                            ...
                                            <div className="row">
                                                <div className="col-sm-12">
                                                    ...
                                                    <div className="collection-product-wrapper">
                                                        ...
                                                        <BrandListing colSize={this.state.layoutColumns}/>
...
export default CollectionBrandSidebar;