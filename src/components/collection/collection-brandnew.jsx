...
import Filterseller from "./common/filterseller";
import FilterBar from "./common/filter-bar";
import BrandnewListing from "./common/brandnew-listing";
import StickyBox from "react-sticky-box";


class CollectionBrandnew extends Component {
                                            ...
                                            <div className="row">
                                                <div className="col-sm-12">
                                                    ...
                                                    <div className="collection-product-wrapper">
                                                        ...
                                                        <BrandnewListing colSize={this.state.layoutColumns}/>
...
export default CollectionBrandnew;