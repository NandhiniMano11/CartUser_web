...
import Sanaya from './components/layouts/sanaya/main';
...
import CollectionBrandnew from "./components/collection/collection-brandnew";
				...
				<BrowserRouter basename={'/'} >
					<ScrollContext>
						<Switch>
							...
							<Route path={`${process.env.PUBLIC_URL}/sanaya`} component={Sanaya}/>
                            ...
                            <Layout>
								...
								<Route path={`${process.env.PUBLIC_URL}/brand-sidebar/collection`} component={CollectionBrandSidebar}/>
								...
								<Route path={`${process.env.PUBLIC_URL}/brandnew/collection`} component={CollectionBrandnew}/>
                                ...
                                <Route path={`${process.env.PUBLIC_URL}/pages/register`} component={Register}/>
                                  <Route path={`${process.env.PUBLIC_URL}/pages/register1`} component={Register1}/>
