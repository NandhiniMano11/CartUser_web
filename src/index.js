...
import Register1 from './components/pages/buyerRegister';
          ...
          <BrowserRouter basename={'/'}>
            <ScrollContext>
              <Switch>
                ...
                />
                <Route
                  path={`${process.env.PUBLIC_URL}/sanaya`}
                  component={Sanaya}
                />
                <Route
                ...
                <Layout>
                  ...
                  />
                  <Route
                    path={`${process.env.PUBLIC_URL}/brand-sidebar/collection`}
                    component={CollectionBrandSidebar}
                  />
                  <Route
                  ...
                  />
                  <Route
                    path={`${process.env.PUBLIC_URL}/brandnew/collection`}
                    component={CollectionBrandnew}
                  />
                  ...
                  />
                  <Route
                    path={`${process.env.PUBLIC_URL}/pages/buyerRegister`}
                    component={Register1}
                  />
                  <Route
